...
//create bucket using bucket name
    $bucket1= $client->createBucket(array('Bucket'=> $cors1));
    $bucket2= $client->createBucket(array('Bucket'=> $cors2));
...
echo "<h2 align=\"center\"><a href=\"createfile.php?bucket=$bucketname\">Click here to create file</a></h2>";
